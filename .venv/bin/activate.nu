...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/johann/Documents/projet12/.venv'
    let bin = 'bin'
    let path-sep = ':'
    ...
    let virtual-prompt = if ('projet12' == '') {
...
alias deactivate = source '/Users/johann/Documents/projet12/.venv/bin/deactivate.nu'
